...
namespace HARMIC.Areas.Admin.Controllers
{
    ...
    public class AdminRolesController : Controller
    {
        ...
        public AdminRolesController(Travel_BookerContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("RoleId,RoleName,Description")] Role role)
        {
            if (ModelState.IsValid)
            {
                ...
                _notifyService.Success("Successful new creation");
        ...
        public async Task<IActionResult> Edit(int id, [Bind("RoleId,RoleName,Description")] Role role)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    _notifyService.Success("Successful login");
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            _notifyService.Success("Remove access successfully");
            return RedirectToAction(nameof(Index));
        }
