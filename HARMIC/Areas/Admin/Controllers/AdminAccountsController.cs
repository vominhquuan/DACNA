...
namespace HARMIC.Areas.Admin
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(Travel_BookerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var travel_BookerContext = _context.Accounts.Include(a => a.Role);
            return View(await travel_BookerContext.ToListAsync());
        }
